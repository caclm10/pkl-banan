...
<div class="admin-main">
    ...
    <form action="/admin/about-setup/misi/update/<?= $misi['id'] ?>" method="POST">
        <div class="mb-3">
            <label for="konten" class="form-label">Konten</label>
            <textarea name="konten" id="konten" class="form-control <?= getValidationErrorClass('konten') ?>" data-autosize><?= old('konten', $misi['konten']) ?></textarea>
